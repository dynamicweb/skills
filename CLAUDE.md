...
lacks a trigger signal, a SKILL.md body runs past 500 lines or 16,000 characters, or a reference
over 100 lines lacks a table of contents (including references in nested folders).
