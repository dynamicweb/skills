...
- [`../../dw-tbd-pim-demo/references/localization.md`](../../dw-tbd-pim-demo/references/localization.md) â€” the product side (translate product names, descriptions, custom fields).
