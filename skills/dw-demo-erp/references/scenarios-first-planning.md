...
- One dashboard widget per scenario row that needs a "watch this widget change" beat (and watch the [`../dw-demo-pim/references/governance.md`](../../dw-demo-pim/references/governance.md) rule: `RepositoryCountWidget` for drill-through, never `ScalarSqlCountWidget`).
...
- The "go deep, not wide" demo philosophy: [`../dw-demo-base/SKILL.md`](../../dw-demo-base/SKILL.md) "Demo philosophy".
- The customer-context read-only contract that protects the customer-supplied PDF: [`../dw-demo-base/references/customer-context.md`](../../dw-demo-base/references/customer-context.md).
