...
Inherited principle from [`dynamicweb-demo-base/SKILL.md` "Demo philosophy"](../dw-tbd-demo-base/SKILL.md). PIM-specific guardrails:
...
The vendor skill-repo consultation outcome (`dynamicweb/skills` + `dynamicweb/ai-implementor-skills`) is documented in [dynamicweb-demo-base/references/vendor-patterns.md](../dw-tbd-demo-base/references/vendor-patterns.md).
