...
| `serialized-data` differs | **Highest-stakes drift.** Baseline rolls cascade into Swift's [`../../dw-tbd-swift-demo/references/deserialize-flow.md`](../../dw-tbd-swift-demo/references/deserialize-flow.md) results. Check INDEX.md and the per-baseline subfolder's own `README.md` for the version stamp. |
