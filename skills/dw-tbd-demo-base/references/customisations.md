...
Cross-reference: [`../../dw-tbd-swift-demo/references/dw10-canonical-surfaces.md`](../../dw-tbd-swift-demo/references/dw10-canonical-surfaces.md) Â§"Cross-cutting redirects" â€” the `NotificationSubscriber` on `Notifications.Standard.Page.Loaded` is the canonical anon-gate / role-gate hook and does NOT trigger this preflight.
