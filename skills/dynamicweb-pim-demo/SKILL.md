...
Inherited principle from [`dynamicweb-demo-base/SKILL.md` "Demo philosophy"](../dynamicweb-demo-base/SKILL.md). PIM-specific guardrails:
...
The vendor skill-repo consultation outcome (`dynamicweb/skills` + `dynamicweb/ai-implementor-skills`) is documented in [dynamicweb-demo-base/references/vendor-patterns.md](../dynamicweb-demo-base/references/vendor-patterns.md).
