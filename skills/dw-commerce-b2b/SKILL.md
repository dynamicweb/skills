...
| Inspect what a user can see | `get_assortment_ids_by_user` (a USER id; a group id answers `[]`), `get_assortment_permissions_by_user`, `check_assortment_product_access` |
