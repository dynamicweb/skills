...
A PIM demo's role roster is project-specific. This ref does NOT prescribe role names â€” use customer-specific roles only after the customer-context PDF has been read (per the [`dynamicweb-demo-base/references/customer-context.md`](../../dw-demo-base/references/customer-context.md) read-only contract). For demo-skill purposes use abstract roles:
