...
| Blank cells in spec/attribute components (admin shows values) | Stored list-field value is the display name, not `FieldOptionValue` | [`foundational/pim-modelling.md`](../../dw-pim-modelling/references/structural-model.md) §2.8 |
