...
mcp: none
dynamo: false
description: 'Fold demo learnings into skills as sanitized PRs. Triggers: fold back a learning, save a demo fix to the plugin. General skill authoring -> dw-skill-authoring. Use AFTER dw-demo-base.'
---
