...
> Bring the local DW host up at a stable public HTTPS URL via ngrok so a Business Central tenant can call it. Loaded from `~/.claude/skills/dw-integration-bc/SKILL.md` "Where to find things" table.
