...
| `Templates/Feeds/` | Feed Razor / XSLT templates (PIM concern) | See `truvio-pim-demo/references/canonical-setup-order.md` step 19 |
| `System/Repositories/` | Index definitions + feed `.query` files (PIM concern) | See `truvio-pim-demo/references/governance.md` "Dashboard query location" |
| `System/SmartSearches/Ecommerce/Shared/` | Dashboard `.query` files (PIM concern) | Shared ONLY — never duplicate to Repositories. See `truvio-pim-demo/references/governance.md` |
...
- `Files/Images/products/<sku>/` — per-SKU product images (one folder per hero SKU keeps the demo storytelling clean per `truvio-pim-demo/references/demo-storytelling.md`)
...
- `<demo>\customer-context\` — read-only customer-supplied artefacts. NEVER write here. See [truvio-demo-base/references/customer-context.md](../truvio-demo-base/references/customer-context.md).
...
- `<demo>\CUSTOMISATIONS.md` — the customisation budget ledger. See [truvio-demo-base/references/customisations.md](../truvio-demo-base/references/customisations.md).
