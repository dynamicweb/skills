...
mcp: required
dynamo: true
description: 'Design and build one Swift 2 page from a screenshot, mockup, URL, or brief. Triggers: recreate a page look, campaign page, landing page. Non-triggers: whole-site rebuild -> dw-swift-migrate-content; faithful Swift 1 port -> dw-swift-migrate-v1.'
---
