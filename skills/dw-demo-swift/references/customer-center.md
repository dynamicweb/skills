...
Source-of-truth: `$env:DW_VAULT\serialized-data\swift-2.3\deploy\_content\Swift 2\Customer center\` deserialized into a running host. Backtick-quote any path string when copying into other tools -- folder names contain spaces.
