...
> `wwwroot/Files/` asset organisation for a Swift 2.2 / Dynamicweb 10 demo. Reference layouts at `$env:DW_VAULT\serialized-data\swift-2.3\` and Swift v2.3.0 at https://github.com/dynamicweb/Swift.
>
