...
> `wwwroot/Files/` asset organisation for a Swift 2.2 / Dynamicweb 10 demo. Reference layouts at `<demo-root>\distribution\layers\surface-swift\` (the Swift content layer; `base` is framework-only) and Swift v2.3.0 at https://github.com/dynamicweb/Swift.
>
