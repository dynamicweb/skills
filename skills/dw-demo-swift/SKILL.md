...
| Customer-center playbook (Account vs CSR; impersonation flow; seeding the section's orders/quotes/carts/favorites; why CSR/Accounts or My-orders looks empty; gating buyer dashboards away from the CSR; customer-specific / contract pricing) | references/customer-center.md |
