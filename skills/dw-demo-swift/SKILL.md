...
| **Install a feature pack into a demo host** (resolve from the `feature-packs` vault slot, source-drop the `.cs`, copy disk overlays, deserialize the fragment AFTER the base baseline) | **references/pack-activation.md** |
