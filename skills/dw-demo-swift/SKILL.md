...
| Customer-center playbook (Account vs CSR; impersonation flow; seeding the section's orders/quotes/carts/favorites/addresses; why CSR/Accounts or My-orders looks empty; why checkout shows no billing address) | references/customer-center.md |
