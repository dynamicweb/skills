...
The ERP writes these rows; the PIM displays read-only. Frontend pricing resolution is via `Dynamicweb.Ecommerce.Prices.PriceManager` (use the real API, not URL parsing or raw SQL -- see [`../dw-tbd-swift-demo/references/dw10-canonical-surfaces.md`](../../dw-tbd-swift-demo/references/dw10-canonical-surfaces.md)).
...
- PIM-side modelling of categories, attributes, and prices: [`../dw-tbd-pim-demo/references/structural-model.md`](../../dw-tbd-pim-demo/references/structural-model.md).
- Frontend price resolution (use `PriceManager`, not raw SQL): [`../dw-tbd-swift-demo/references/dw10-canonical-surfaces.md`](../../dw-tbd-swift-demo/references/dw10-canonical-surfaces.md).
