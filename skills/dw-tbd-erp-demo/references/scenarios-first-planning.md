...
- One dashboard widget per scenario row that needs a "watch this widget change" beat (and watch the [`../dw-tbd-pim-demo/references/governance.md`](../../dw-tbd-pim-demo/references/governance.md) rule: `RepositoryCountWidget` for drill-through, never `ScalarSqlCountWidget`).
...
- The "go deep, not wide" demo philosophy: [`../dw-tbd-demo-base/SKILL.md`](../../dw-tbd-demo-base/SKILL.md) "Demo philosophy".
- The customer-context read-only contract that protects the customer-supplied PDF: [`../dw-tbd-demo-base/references/customer-context.md`](../../dw-tbd-demo-base/references/customer-context.md).
