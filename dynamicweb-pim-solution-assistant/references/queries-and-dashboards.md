...
3. get_dashboard_areas -> create_dashboards   -> one dashboard per area (e.g. Products)
4. add_widgets_to_dashboards                  -> one call per widget
```
